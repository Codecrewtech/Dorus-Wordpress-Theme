...
<div class="featured-boxes login collapse fade" id="checkout-login-form">
	<div class="featured-box featured-box-secundary default">
		<div class="box-content">
			<h4><?php esc_html_e( 'I\'m a Returning Customer', 'tomato' ); ?></h4>
			<form method="post" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
                ...
                <div class="row">
					<div class="form-group">
						<div class="col-md-12">
							<label for="username"><?php _e( 'Username or email', 'tomato' ); ?> <span class="required">*</span></label>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<input type="submit" value="<?php _e( 'Login', 'tomato' ); ?>" class="btn btn-primary pull-right push-bottom" data-loading-text="Loading...">
