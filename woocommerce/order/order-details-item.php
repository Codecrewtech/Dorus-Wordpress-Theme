...
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
    ...
    <td class="product-name">
		<?php
			...
			echo  function_exists('wc_display_item_meta') ? wc_display_item_meta( $item ) : $order->display_item_meta( $item );
			echo  function_exists('wc_display_item_downloads') ? wc_display_item_downloads( $item ) : $order->display_item_downloads( $item );
