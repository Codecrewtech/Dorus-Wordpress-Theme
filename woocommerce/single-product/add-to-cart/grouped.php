...
<form class="cart" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<div class="shop-btn-wrap"><button type="submit" class="single_add_to_cart_button button btn-small no-width alt"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button></div>
