<section class="home-section"  <?php if( $spyropress_bg_image )echo 'style="background: url('. esc_url( $spyropress_bg_image ) .') no-repeat center center;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;"' ?> data-stellar-background-ratio="0.2">
