...
class SpyropressAdmin {
    ...
    function construct_admin_menu() {
        ...
        $this->admin_menu_parent = array(
            'page_title' => esc_html__( 'Welcome to ThemeSquared', 'tomato' ),
            'menu_title' => esc_html__( 'ThemeSquared', 'tomato' ),
            'slug' => 'spyropress',
            'position' => '55'
        );
        ...
        $this->admin_menus['spyropress'] = array(
            'page_title' => esc_html__( 'Welcome to ThemeSquared', 'tomato' ),
            'menu_title' => esc_html__( 'Dashboard', 'tomato' ),
        ...
        if ( $spyropress->is_builder_verified ) {
            ...
            $this->admin_menus['spyropress-update'] = array(
                'page_title' => esc_html__( 'Theme Updates', 'tomato' ),
                'menu_title' => esc_html__( 'Theme Updates', 'tomato' ) . $count,
