    ...
    <div <?php echo build_section_class( 'section-background', $item ); ?>>
        ...
        <div class="controls">
            ...
            <?php 
                ...
                printf( '<input class="upload_button button-secondary" type="button" value="'.esc_html__( 'Upload', 'tomato' ).'" id="upload_%s" />', $id);
            ...
            <div class="section-radio-img section-pattern">
                <h3 class="heading"><?php _e( 'Background Patterns', 'tomato' ); ?></h3>
                <ul id="bg_patterns">
                <?php
...
function spyropress_panel_background_repeat() {
    return array(
        ''          => '',
        'no-repeat' => esc_html__( 'No Repeat', 'tomato' ),
        'repeat'    => esc_html__( 'Repeat All', 'tomato' ),
        'repeat-x'  => esc_html__( 'Repeat Horizontally', 'tomato' ),
        'repeat-y'  => esc_html__( 'Repeat Vertically', 'tomato' ),
...
function spyropress_panel_background_attachment() {
    return array(
        ''          => '',
        'fixed'   => esc_html__( 'Fixed', 'tomato' ),
        'scroll'  => esc_html__( 'Scroll', 'tomato' ),
        'inherit' => esc_html__( 'Inherit', 'tomato' )
    );
}
...
function spyropress_panel_background_position() {
    return array(
        ''          => '',
        'left top'      => esc_html__( 'Left Top', 'tomato' ),
        'left center'   => esc_html__( 'Left Center', 'tomato' ),
        'left bottom'   => esc_html__( 'Left Bottom', 'tomato' ),
        'center top'    => esc_html__( 'Center Top', 'tomato' ),
        'center center' => esc_html__( 'Center Center', 'tomato' ),
        'center bottom' => esc_html__( 'Center Bottom', 'tomato' ),
        'right top'     => esc_html__( 'Right Top', 'tomato' ),
        'right center'  => esc_html__( 'Right Center', 'tomato' ),
        'right bottom'  => esc_html__( 'Right Bottom', 'tomato' )
    );
}
?>