...
function spyropress_ui_repeater( $item, $id, $value, $is_widget = false, $is_builder = false ) {
    ...
    echo '<div ' . build_section_class( 'section-repeater section-full', $item ) . '>';
        ...
        echo '<div class="controls">';
            for( $i = 0; $i <= $count; $i++) {
                ...
                echo '<div class="repeater-group' . $tocopy . '">';
                    ...
                    echo '<div class="repeater-group-actions pb10">';
                        echo '<a href="#" class="repeater-delete">' . esc_html__( 'Remove', 'tomato' ) . '</a>';
  						echo '<span class="meta-sep">|</span>';
  						echo '<a href="#" class="repeater-close">' . esc_html__( 'Close', 'tomato' ) . '</a>';
            ...
            // add button
            echo '<button class="repeater-add button">' . esc_html__( 'Add New', 'tomato' ) . ' ' . $item['label'] . '</button>';
        echo '</div>';
    echo '</div>';
