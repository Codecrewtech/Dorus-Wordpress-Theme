...
function spyropress_ui_import( $option_name ) {
    ...
    $item['label'] = esc_html__( 'Import Options', 'tomato' );
    $item['desc'] = esc_html__( 'Input your backup file below and hit import to restore your site options from backup.', 'tomato' );
    ...
    echo '<div class="section section-import section-full">';
        ...
        printf(
            ...
            esc_attr( 'Import Options' ), esc_html__( 'WARNING! This will overwrite any existing options, please proceed with caution!', 'tomato' )
        );
    echo '</div>';
}
...
function spyropress_ui_export( $option_name ) {
    ...
    $item['label'] = esc_html__( 'Export Options', 'tomato' );
    $item['desc'] = esc_html__( 'Here you can download or copy/paste into a blank file your theme current option settings. Keep this safe as you can use it as backup should anything go wrong. Or you can use it to restore your settings on this site (or any other site).', 'tomato' );
    ...
    echo '<div class="section section-export section-full">';
        ...
        printf(
            ...
            esc_html__( 'Download Options', 'tomato' )
        );
...
function spyropress_ui_import_dummy( $option_name ) {
    ...
    $item['label'] = esc_html__( 'Import Dummy Content: Posts, Pages, Categories', 'tomato' );
    $item['desc'] = esc_html__( 'If you are new to wordpress or have problems creating posts or pages that look like the Theme Demo you can import dummy posts and pages here that will definitely help to understand how those tasks are done.', 'tomato' );
    ...
    /*echo '<div class="section section-import section-full">';
        ...
        echo '<div class="controls">';
            printf(
                ...
                esc_attr( 'Import Demo Data', 'tomato' ), esc_html__( 'WARNING! This will overwrite any existing options, please proceed with caution!', 'tomato' )
            );
        echo '</div>';
        build_description( $item );
