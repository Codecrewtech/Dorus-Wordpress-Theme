...
;(function($) {
	...
	panelUi = {
		...
		init_radio_image: function() {
            ...
            $('.section-radio-img').on('click', '.radio-img', function() {
			...
			$('body').on( 'click', '.upload_button', function( e ) {
				...
				wp.media.editor.send.attachment = function(props, attachment) {
					...
					if( 'video' != attachment.type ) {
    					...
    					btnContent = '';
    					btnContent += '<div class="image-wrap"><img src="' + img + '"  /></div>';
		...
		init_upload_remove: function() {
			...
			$('body').on('click', '.remove-media',  function(event) {
		...
		save_settings: function() {
            ...
            $('.save-options', panelUi.id).on('click', function(event) {
		...
		reset_settings: function() {
			$('.reset-options', panelUi.id).on('click', function(event) {
		...
		import_settings: function() {
			$('.import-options', panelUi.id).on('click', function(event) {
