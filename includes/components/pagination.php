...
function wp_pagenavi( $args = array() ) {
    ...
    $defaults = array(
        ...
        'style' => 'list',
		'options' => array(
            'pages_text'    => get_setting('pagination_pages_text', esc_html__( 'Page %CURRENT_PAGE% of %TOTAL_PAGES%', 'tomato' )),
            'current_text'  => get_setting('pagination_current_text', '%PAGE_NUMBER%'),
            'page_text'     => get_setting('pagination_page_text', '%PAGE_NUMBER%'),
            'first_text'    => get_setting('pagination_first_text', esc_html__( '&laquo; First', 'tomato' )),
            'last_text'     => get_setting('pagination_last_text', esc_html__( 'Last &raquo;', 'tomato' )),
            'prev_text'     => get_setting('pagination_prev_text', esc_html__( '&laquo;', 'tomato' )),
            'next_text'     => get_setting('pagination_next_text', esc_html__( '&raquo;', 'tomato' )),
            'dotleft_text'  => get_setting('pagination_dotleft_text', esc_html__( '&hellip;', 'tomato' )),
            'dotright_text' => get_setting('pagination_dotright_text', esc_html__( '&hellip;', 'tomato' )),
